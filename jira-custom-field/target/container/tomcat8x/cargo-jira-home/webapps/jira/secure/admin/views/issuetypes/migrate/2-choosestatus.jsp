	...
	<page:applyDecorator name="jiraform">
        ...
        <page:param name="instructions">
           ...
           <ww:component name="'issuetype'" template="constanticon.jsp">
             ...
             <ww:param name="'alt'"><ww:property value="/currentIssueContext/issueTypeObject/name" /></ww:param>
           </ww:component>
            <ww:text name="'admin.issuemigration.issue.type.not.valid'">
                <ww:param name="'value0'"><strong><ww:property value="/currentIssueContext/issueTypeObject/name" /></strong></ww:param>
                <ww:param name="'value1'"><strong><ww:property value="/currentIssueContext/projectObject/name" /></strong></ww:param>
            ...
            <strong><ww:property value="/bulkEditBean/targetIssueTypeObject/name" /></strong></ww:param>
            </ww:text>
