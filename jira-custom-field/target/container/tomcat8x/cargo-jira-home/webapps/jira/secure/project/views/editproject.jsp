...
<html>
<head>
    <title><ww:text name="'admin.projects.edit.project'"/>: <ww:property value="projectObject/name" /></title>
...
<page:applyDecorator id="project-edit" name="auiform">
    ...
    <aui:component template="formHeading.jsp" theme="'aui'">
        <aui:param name="'text'"><ww:text name="'admin.projects.edit.project'"/>: <ww:text name="projectObject/name" /></aui:param>
    </aui:component>
