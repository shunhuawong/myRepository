	...
	<page:applyDecorator name="jiraform">
        ...
        <page:param name="instructions">
            ...
            <ww:iterator value="/multiBulkMoveBean/issuesInContext" status="'status'">
               <li><a href="#<ww:property value="./key/projectObject/id" /><ww:property value="./key/issueTypeObject/id" />"><ww:property value="./key/projectObject/name" /> - <ww:property value="./key/issueTypeObject/nameTranslation" /></a></li>
            </ww:iterator>
            </ul>
        </page:param>
            ...
            <ww:iterator value="./multiBulkMoveBean/bulkEditBeans" status="'status'">
                <page:applyDecorator name="jirapanel">
                    <page:param name="title">
                        <strong><ww:property value="./key/projectObject/name" /></strong> -
                        <ww:component name="'issuetype'" template="constanticon.jsp">
                          ...
                          <ww:param name="'alt'"><ww:property value="/nameTranslation(./key/issueTypeObject)" /></ww:param>
                        </ww:component>
                        <strong><ww:property value="/nameTranslation(./key/issueTypeObject)" /></strong>
                    </page:param>
                    <page:param name="instructions">
                        <p id="<ww:property value="./key/projectObject/id" /><ww:property value="./key/issueTypeObject/id" />">
                            <ww:text name="'admin.issuemigration.confirmation.summary.of.changes'">
                                ...
                                <ww:param name="'value1'"><strong><ww:property value="./key/projectObject/name" /></strong></ww:param>
                                <ww:param name="'value2'"><strong><ww:property value="/nameTranslation(./key/issueTypeObject)" /></strong></ww:param>
                            </ww:text>
                        </p>
                    </page:param>
