...
<head>
    ...
    <jira:web-resource-require modules="jira.webresources:default-group-global-permission-check" />
</head>
<body>
<page:applyDecorator name="jirapanel">
    ...
    <ww:text name="'admin.globalpermissions.instruction'">
        ...
        <ww:param name="'value2'"><a href="<%= request.getContextPath() %>/secure/admin/ApplicationAccess.jspa"></ww:param>
    </ww:text>
    </p>
</page:applyDecorator>
