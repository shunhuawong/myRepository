...
<ww:iterator value="roleActorTypes">
    <td>
        <ww:if test="/roleActorTypes(.., ./type, -1)/size() != 0">
            <span id="short_<ww:property value="../id"/>_<ww:property value="./type"/>"  onclick="toggle('expand', '<ww:property value="../id"/>_<ww:property value="./type"/>');">
            ...
            <ww:if test="/roleActorTypes(.., ./type, -1)/size() > 3">
                <span style="display:none; cursor:pointer;" id="long_<ww:property value="../id"/>_<ww:property value="./type"/>" onclick="toggle('hide', '<ww:property value="../id"/>_<ww:property value="./type"/>');">
