            ...
            <div class="section">
                ...
                <ww:if test="/subTasksEnabled == true">
                    ...
                    <ww:iterator value="/subTaskIssueTypes">
                        <%-- Get the Issue Type Object Instead --%>
                        <ww:property value="/issueType/id">
                        <dt>
                            <ww:component name="'issuetype'" template="constanticon.jsp">
                                <ww:param name="'contextPath'"><%= request.getContextPath() %></ww:param>
                                <ww:param name="'iconurl'" value="./iconUrl" />
                                <ww:param name="'title'"><ww:property value="/issueType/descTranslation"/></ww:param>
                            </ww:component>
                            <ww:property value="/issueType/nameTranslation"/>
                        </dt>
                        <dd><ww:property value="/issueType/descTranslation"/></dd>
                        </ww:property>
                    </ww:iterator>
                    </dl>
                </ww:if>
