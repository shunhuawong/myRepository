...
<table class="aui aui-table-rowhover">
    ...
    <tbody>
    <ww:iterator value="/projectManager/allProjectCategories" status="'status'">
        <tr>
            ...
            <ww:iterator value="/projectManager/projectsFromProjectCategory(.)">
                <a href="<%= request.getContextPath() %>/plugins/servlet/project-config/<ww:property value="key"/>/summary"><ww:property value="name" /></a><br>
            </ww:iterator>
            </td>
            <td>
                <ul class="operations-list">
                    <li><a href="EditProjectCategory!default.jspa?id=<ww:property value="id"/>"><ww:text name="'common.words.edit'"/></a></li>
                    <li><a id="del_<ww:property value="name"/>" href="DeleteProjectCategory!default.jspa?id=<ww:property value="id"/>"><ww:text name="'common.words.delete'"/></a></li>
                </ul>
            </td>
        </tr>
    </ww:iterator>
