    ...
    <page:applyDecorator name="bulkpanel" >
        <page:param name="title">
            ...
            <ww:text name="'bulk.migrate.overview.subtask.title'">
                <ww:param name="'value0'"><strong><ww:property value="/rootBulkEditBean/relatedMultiBulkMoveBean/currentBulkEditBean/targetProject/name"/></strong></ww:param>
                <ww:param name="'value1'"><strong><ww:property value="/rootBulkEditBean/relatedMultiBulkMoveBean/currentBulkEditBean/targetIssueTypeObject/name"/></strong></ww:param>
            </ww:text>
        </page:param>
        ...
        <page:param name="instructions">
            ...
            <ww:text name="'bulk.migrate.overview.subtask.instructions'">
                ...
                <ww:param name="'value1'"><strong><ww:property value="/rootBulkEditBean/relatedMultiBulkMoveBean/currentBulkEditBean/targetIssueTypeObject/name"/></strong></ww:param>
                <ww:param name="'value2'"><strong><ww:property value="/rootBulkEditBean/relatedMultiBulkMoveBean/currentBulkEditBean/targetProject/name"/></strong></ww:param>
