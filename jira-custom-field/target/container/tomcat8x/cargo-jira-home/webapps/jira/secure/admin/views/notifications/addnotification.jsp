...
<page:applyDecorator name="jiraform">
    ...
    <ui:select label="text('admin.notifications.events')" name="'eventTypeIds'" template="selectmultiple.jsp" list="events" listKey="'key'" listValue="'value/translatedName(/loggedInUser)'" size="7">
    ...
    <tr>
        ...
        <td class="fieldValueArea">
            ...
            <ww:elseIf test="types/(.)/type == 'group'">
                <select name="<ww:property value="."/>" <ww:if test="types/size > 1">onChange="document.forms['jiraform'].type[<ww:property value="@itStatus/index"/>].checked = true;"</ww:if> class="js-default-single-group-picker">
                    <option data-placeholder="true"><ww:text name="'admin.notifications.choose.a.group'"/></option>
                </select>
            </ww:elseIf>
