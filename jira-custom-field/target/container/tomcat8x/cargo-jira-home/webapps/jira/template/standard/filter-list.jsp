            ...
            <ww:iterator value="." status="'myStatus'">
                ...
                <ww:if test="parameters['issuecount'] != 'false'">
                    <td>
                        ...
                        <ww:else>
                            <a href="<ww:url value="'/issues/'" atltoken="false"><ww:param name="'filter'" value="./id" /></ww:url>"><ww:property value="./issueCount" /></a>
                        </ww:else>
                    </td>
                </ww:if>
                ...
                <ww:if test="parameters['subscriptions'] != 'false'">
                    <td>
                        <ww:if test="./subscriptionCount == 0">
                            <ww:text name="'common.words.none'"/> - <a id="subscribe_<ww:property value="./name"/>" class="trigger-dialog" href="<ww:url value="'EditSubscription!default.jspa'"><ww:param name="'filterId'" value="./id" /></ww:url>"><ww:text name="'managefilters.subscribe'"/></a>
                        </ww:if>
