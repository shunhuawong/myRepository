...
<ww:if test="hasGlobalPermission('USER_PICKER') == true">
    <a href="javascript:openMultiWindow('<ww:property value="parameters['name']"><ww:if test="."><ww:property value="."/></ww:if><ww:else>multiuserpicker</ww:else></ww:property>');"><span class="icon-default aui-icon aui-icon-small aui-iconfont-admin-roles" title="<ww:text name="'user.picker.select.users'"/>"></span></a>
</ww:if>
<ww:else>
