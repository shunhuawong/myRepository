AJS.test.require([
    "jira.webresources:jqlautocomplete",
    "jira.webresources:ajax-favourite-control",
    ...
    var ensureOldNamespaceCallsNew = function (oldNamespaceStr, newNamespaceStr) {
        ok(
            eval(oldNamespaceStr + "===" + newNamespaceStr + " && " + oldNamespaceStr), // eslint-disable-line no-eval
