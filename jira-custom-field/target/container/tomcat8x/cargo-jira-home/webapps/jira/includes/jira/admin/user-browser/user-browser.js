define('jira/admin/user-browser',[
    'jira/togglelist/toggle-list',
    'jquery',
    ...
    function initPostSetupAnnouncements(inviteUserSelector) {
        var postSetupAnnouncements = {
            'create.user.mail.properties.setup': new Announcements.Announcement(
                'create.user.mail.properties.setup',
                Announcements.soyTemplateAnnouncementBody(Templates.userBrowserEmailDiscovery),
                Announcements.inViewPort(Announcements.findElement(inviteUserSelector)),
                Announcements.GRAVITY_BELOW,
                30,
                true
            )
        };
    ...
    UserBrowser.initNewUsersTip = function(inviteUserSelector, createUserSelector) {
        ...
        var inviteUserButton = jQuery(inviteUserSelector), createUserButton = jQuery(createUserSelector);
