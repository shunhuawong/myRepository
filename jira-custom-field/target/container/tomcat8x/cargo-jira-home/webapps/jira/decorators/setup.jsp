...
<%
    ...
    for (Iterator<Map.Entry<String, String>> iterator = webResourceManager.getMetadata().entrySet().iterator(); iterator.hasNext(); )
    {
        final Map.Entry<String, String> metaDataEntry = iterator.next();
