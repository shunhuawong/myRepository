AJS.test.require([
    ...
    "jira.webresources:select-pickers",
    ...
    var CheckboxMultiSelectStatusLozenge = require("jira/ajs/select/checkbox-multi-select-status-lozenge");

    module("CheckboxMultiSelectStatusLozenge", {
        setup: function () {
            this.sandbox = sinon.sandbox.create();
            this.sandbox.stub(jQuery.fn, "tipsy");
            ...
            var control = new CheckboxMultiSelectStatusLozenge({
                element: $select,
