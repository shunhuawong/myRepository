...
<ww:if test="applicationProperties/string('jira.setup') == 'true'">
    <ww:if test="loggedInApplicationUser == null && projectManager/projects/size > 0">
    ...
    <ww:else>
        <ww:if test="projectManager/projects/size > 0">
            ...
            <p>
                <ww:if test="hasGlobalPermission('ADMINISTER') == true">
                    <ww:text name="'noprojects.viewallprojects.message'">
        ...
        <ww:else>
            ...
            <p>
                <ww:if test="hasGlobalPermission('ADMINISTER') == true">
                    <a class="add-project-trigger" href="<%= request.getContextPath() %>/secure/project/ViewProjects.jspa"><ww:text name="'noprojects.createprojectnow.link'"/></a>.
                </ww:if>
                <ww:else>
