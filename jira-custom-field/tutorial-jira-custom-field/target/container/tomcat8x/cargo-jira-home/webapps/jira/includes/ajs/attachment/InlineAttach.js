define('jira/attachment/inline-attach', [
     ...
     * <ol>
     *
     * @class InlineAttach.UploadProgress
     * @extends Class
     */
    ...
    jQuery.extend(InlineAttach.UploadProgress, /** @lends InlineAttach.UploadProgress */ {
        /**
     ...
     * @class InlineAttach.UnknownProgress
     * @extends Class
     */
    ...
    InlineAttach.Form = Class.extend({
         ...
         * @return {InlineAttach.UploadProgress} the newly created UploadProgress.
         */
         ...
         * @return {InlineAttach.UnknownProgress} the newly created UnknownProgress.
         */
     ...
     * @class InlineAttach.FormUpload
     * @extends Class
     */
    InlineAttach.FormUpload = Class.extend({
        /**
         * @constructs
         * @param {Object} options the configuration for the upload.
         * @param {jQuery} options.input - Element defining the file input HTML element
         * @param {String} options.url - The url to POST the attachment to
         * @param {Object} options.params - Set of HTML parameters to send along with the file
         * @param {Object} options.scope - The scope will be assigned to "this" when a callback is executed. Defaults to the FormUpload.
         * @param {Function} options.success - Function called when the upload succeeds. The first argument will be the data returned from the upload.
         * @param {Function} options.error - Function called when the fails. The first argument will be any text received from the server during the upload.
         * @param {Function} options.before - Function called just before the upload starts.
         * @param {Function} options.after - Function called after the upload has finished. It will be called always, even if the upload failed or is aborted
         * @param {Function} options.abort - Function called once the request is aborted.
         */
    ...
    InlineAttach.AjaxUpload = Class.extend({
         ...
         * @param {String} options.url - The url to POST the attachment to
         * @param {Object} options.params - Set of HTML parameters to send along with the file.
         * @param {Object} options.scope - The scope will be assigned to "this" when a callback is executed. Defaults to the AjaxUpload.
         * @param {Function} options.success - Function called when the upload succeeds. The first argument will be the data returned from the upload.
         * @param {Function} options.error - Function called when the fails. The first argument will be any text received from the server during the upload.
         * @param {Function} options.abort - Function called after the upload is aborted.
         * @param {Function} options.after - Function called after the upload has finished. It will be called always, even if the upload failed or was aborted.
         * @param {Function} options.progress - Function called as the upload progresses with the amount of data currently uploaded. Always passed as bytes.
         */
        init: function(options) {
            var scope = options.scope || null;
            var rescope = InlineAttach.rescope;
    ...
    jQuery.extend(InlineAttach.AjaxUpload, /** @lends InlineAttach.AjaxUpload */{
        /**
    ...
    InlineAttach.Text = (function() {
        ...
        return /** @lends InlineAttach.Text */{
