...
<html>
<head>
	<title><ww:text name="'admin.deleteproject.delete.project'"/>: <ww:property value="project/name" /></title>
...
<page:applyDecorator name="jiraform">
    <page:param name="title"><ww:text name="'admin.deleteproject.delete.project'"/>: <ww:property value="project/name" /></page:param>
	...
	<page:param name="cancelURI"><%= request.getContextPath() %>/plugins/servlet/project-config/<ww:property value="/project/key"/>/summary</page:param>
