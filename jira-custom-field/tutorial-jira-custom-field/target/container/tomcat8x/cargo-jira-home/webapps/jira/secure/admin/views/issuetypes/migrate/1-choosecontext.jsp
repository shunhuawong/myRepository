	...
	<page:applyDecorator name="jiraform">
        ...
        <page:param name="instructions">
            ...
            <ww:component name="'issuetype'" template="constanticon.jsp">
              ...
              <ww:param name="'iconurl'" value="/currentIssueContext/issueTypeObject/iconUrl" />
              <ww:param name="'alt'"><ww:property value="/nameTranslation(/currentIssueContext/issueTypeObject)" /></ww:param>
            </ww:component>
             <strong><ww:text name="'admin.issuemigration.issue.in.project'">
                 <ww:param name="'value0'"><ww:property value="/nameTranslation(/currentIssueContext/issueTypeObject)" /></strong></ww:param>
                 <ww:param name="'value1'"><strong><ww:property value="/currentIssueContext/projectObject/name" /></ww:param>
             </ww:text></strong>
        </page:param>
        ...
        <ui:component name="'pid'" template="hidden.jsp" theme="'single'" value="/currentIssueContext/projectObject/id" />
