...
<body>
<div id="project-delete-form">
    <page:applyDecorator name="jiraform">
        <page:param name="formName">projectdeleteprogressform</page:param>
        <page:param name="method">get</page:param>
        <page:param name="columns">1</page:param>
        <page:param name="width">100%</page:param>
        <page:param name="title"><ww:text name="'admin.projects.delete.project'"/></page:param>
        ...
        <tr bgcolor="#ffffff">
            <td>
                ...
                <ww:else>
                    <page:param name="action">DeleteProjectProgress.jspa</page:param>
