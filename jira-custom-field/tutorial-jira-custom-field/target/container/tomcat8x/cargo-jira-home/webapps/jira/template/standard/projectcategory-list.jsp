        ...
        <ww:iterator value="parameters['categories']" status="'projectCategories'">
            <ww:if test="parameters['projectFetcher']/projectsInCategory(.)/empty == false">
                <tr><td>
                    ...
                    <tr><td>
                        <table id="cat_<ww:property value="id"/>_projects" border="0" cellpadding="3" cellspacing="1" width="100%">
                            <tr bgcolor="#f0f0f0"><td colspan="3">
                                <h3 class="formtitle"><ww:text name="'common.concepts.category'" /> : <ww:property value="name" /></h3>
                            </td></tr>
