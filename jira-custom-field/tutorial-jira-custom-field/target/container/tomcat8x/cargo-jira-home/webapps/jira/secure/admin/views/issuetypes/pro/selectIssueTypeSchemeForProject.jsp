...
<head>
    <title>
        <ww:text name="'admin.projects.issuetypescheme.select.for.project'">
            <ww:param name="'value0'"><ww:property value="/project/name" /></ww:param>
        </ww:text>
    </title>
    <%
	...
	<page:applyDecorator name="jiraform">
		...
		<page:param name="instructions">
            <p><ww:text name="'admin.projects.issuetypescheme.instructions'">
                <ww:param name="'value0'"><strong><ww:property value="/project/name" /></strong></ww:param>
            </ww:text></p>
            <p>
    	...
    	<page:param name="cancelURI"><%= request.getContextPath() %>/plugins/servlet/project-config/<ww:property value="/project/key"/>/issuetypes</page:param>
            ...
            <tr><td colspan="2">
                <div class="warningBox halfWidth centered">
                    ...
                    <a href="<ww:url page="/secure/admin/ConfigureOptionSchemes!default.jspa">
                        ...
                        <ww:param name="'returnUrl'" >/plugins/servlet/project-config/<ww:property value="/project/key"/>/issuetypes</ww:param>
        ...
        <ww:else>
            <ui:component label="text('common.concepts.project')" value="/project/name" template="textlabel.jsp" >
            </ui:component>
