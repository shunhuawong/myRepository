...
<%--                        <td><input type="text" name="<ww:property value="."/>" value="<ww:property value="../parameter(.)"/>"></td>--%>
                    ...
                    <ww:elseIf test="types/(.)/type == 'group'">
                        <td>
                        <select name="<ww:property value="."/>" onChange="document.forms['jiraform'].type[<ww:property value="@status/index"/>].checked = true;" class="js-default-single-group-picker">
                    ...
                    <ww:elseIf test="types/(.)/type == 'applicationRole'">
                        <td>
                        <select name="<ww:property value="."/>" onClick="document.forms['jiraform'].type[<ww:property value="@status/index"/>].checked = true;">
                            <option value=""><ww:text name="'admin.permission.types.application.role.any'"/></option>
                            <ww:iterator value="types/(.)/applicationRoles" >
                                <option value="<ww:property value="key/value"/>" <ww:if test="../../parameter(..) == key/value" >selected</ww:if>><ww:property value="name"/></option>
                            </ww:iterator>
                        </select>
                        </td>
                    </ww:elseIf>
