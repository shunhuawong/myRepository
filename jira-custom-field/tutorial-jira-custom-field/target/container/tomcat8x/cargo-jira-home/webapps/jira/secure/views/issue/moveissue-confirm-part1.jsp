    ...
    <tr>
        ...
        <td>
            ...
            <ww:if test="projectMatch == false">
                <span class="status-inactive"><ww:property value="projectManager/projectObj(issue/long('project'))/name" /></span>
            </ww:if>
            <ww:else>
                <ww:property value="projectManager/projectObj(issue/long('project'))/name" />
            </ww:else>
        </td>
        <td>
            <ww:if test="projectMatch == false">
                <span class="status-active"><ww:property value="targetProjectObj/name" /></span>
            </ww:if>
            <ww:else>
                <ww:property value="targetProjectObj/name" />
            </ww:else>
        </td>
    </tr>
</ww:if>
