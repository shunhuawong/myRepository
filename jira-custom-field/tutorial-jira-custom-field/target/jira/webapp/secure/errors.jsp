...
<%@ page import="com.atlassian.jira.upgrade.UpgradeManager" %>
        ...
        <div class="aui-page-panel">
            <div class="aui-page-panel-inner">
                <section class="aui-page-panel-content">
                    ...
                    <%
                        JohnsonEventContainer appEventContainer = Johnson.getEventContainer(pageContext.getServletContext());
                        ...
                        <tr>
                            <td>
                                ...
                                <% } else if (EventType.get("upgrade").equals(event.getKey())) {
                                    String exportFilePath = ComponentAccessor.getComponent(UpgradeManager.class).getExportFilePath();
