...
<html>
<head>
	<title><ww:text name="'admin.projects.edit.project.lead.and.default.assignee'"/>: <ww:property value="projectObject/name" /></title>
...
<page:applyDecorator id="project-edit-lead-and-default-assignee" name="auiform">
    ...
    <page:param name="cancelLinkURI"><%= request.getContextPath() %>/plugins/servlet/project-config/<ww:property value="/projectObject/key"/>/summary</page:param>

    <aui:component template="formHeading.jsp" theme="'aui'">
        <aui:param name="'text'"><ww:text name="'admin.projects.edit.project.lead.and.default.assignee'"/>: <ww:text name="projectObject/name" /></aui:param>
    </aui:component>
