...
<page:applyDecorator name="jiraform">
    ...
    <tr><td colspan="2">
        ...
        <ww:property value="/configScheme/associatedProjectObjects">
            <ww:if test=".">
                <ww:if test="./size() == 1">
                    <ww:text name="'admin.issuesettings.confirmdeletescheme.one.project'">
                        <ww:param name="'value0'"><ww:property value="./iterator()/next()/name" /></ww:param>
                    </ww:text>
                </ww:if>
                <ww:else>
                    <ww:if test="./size() == 0">
                        ...
                        <ww:text name="'admin.issuesettings.confirmdeletescheme.multiple.projects'">
                            ...
                            <ww:param name="'value1'">
                                <ww:iterator value="." status="'status'">
                                    <ww:if test="@status/first == true">(</ww:if><strong><ww:property value="./name" /></strong><ww:if test="@status/last == true">)</ww:if><ww:else>, </ww:else>
                                </ww:iterator>
                            </ww:param>
                        </ww:text>
                    </ww:else>
