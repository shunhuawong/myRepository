...
<page:applyDecorator id="edit-profile" name="auiform">
    ...
    <ww:elseIf test="/loggedInApplicationUser/name != /username">
        <page:param name="useCustomButtons">true</page:param>
        <aui:component template="formDescriptionBlock.jsp" theme="'aui'">
            <aui:param name="'messageHtml'">
                ...
                <p>
                    <ww:text name="'editprofile.logged.in.as'">
                        <ww:param name="param0"><a href="<%=request.getContextPath()%>/secure/ViewProfile.jspa"><ww:property value="/loggedInApplicationUser/displayName"/></a></ww:param>
                    </ww:text>
                </p>
            </aui:param>
        </aui:component>
    </ww:elseIf>
    <ww:elseIf test="/elevatedSecurityCheckRequired == true">
        <page:param name="useCustomButtons">true</page:param>
        <aui:component template="auimessage.jsp" theme="'aui'">
            <aui:param name="'messageType'">error</aui:param>
            <aui:param name="'messageHtml'">
                <p>
                    <ww:text name="'user.profile.elevated.authorisation.required'"/>
                </p>
            </aui:param>
        </aui:component>
    </ww:elseIf>
