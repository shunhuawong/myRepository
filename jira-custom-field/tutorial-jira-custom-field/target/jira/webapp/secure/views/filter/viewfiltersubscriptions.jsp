    ...
    <ui:soy moduleKey="'jira.webresources:soy-templates'" template="'JIRA.Templates.Headers.pageHeader'">
        ...
        <ui:param name="'actionsContent'">
            <div class="aui-buttons">
                <a class="aui-button" href="<ww:url value="'/issues/'" atltoken="false"><ww:param name="'filter'" value="filterId" /></ww:url>"><ww:text name="'managefilters.filter.view'" /></a>
            </div>
        </ui:param>
    </ui:soy>
                ...
                <ui:param name="'content'">
                    ...
                    <ui:soy moduleKey="'jira.webresources:soy-templates'" template="'JIRA.Templates.Headers.pageHeader'">
                        ...
                        <ui:param name="'actionsContent'"><div class="aui-buttons">
                            <a class="aui-button trigger-dialog" href="<ww:url value="'EditSubscription!default.jspa'"><ww:param name="'filterId'" value="filterId" /></ww:url>">
                                        ...
                                        <td>
                                            <ww:if test="loggedInUserIsOwner(.) == true" >
                                                <ul class="operations-list">
                                                    <li><a class="trigger-dialog" id="edit_subscription" href="<ww:url value="'EditSubscription!default.jspa'"><ww:param name="'subId'" value="id" /><ww:param name="'filterId'" value="filterId" /></ww:url>"><ww:text name="'common.words.edit'"/></a></li>
