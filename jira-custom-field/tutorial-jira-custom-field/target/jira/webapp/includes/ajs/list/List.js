    ...
    return Control.extend({
        ...
        _makeResultDiv: function (data, query) {
            ...
            var $fixedContainer = jQuery('<div class="aui-list-fixed" role="presentation">'),
                $resultsContainer = jQuery('<div class="aui-list-scroll" tabindex="-1" role="presentation">'),
                instance = this,
                ungrouped = [];
         ...
         * @param data
         */
        appendToGroupDescriptor: function (groupId, data) {
        ...
        _renders: {
            ...
            suggestion: function (descriptor, replacementText) {
                ...
                var itemId = AJS.escapeHtml(buildElementId(idSuffix)),
                    listElem = jQuery('<li class="aui-list-item aui-list-item-li-' + itemId + '" role="' + this.options.suggestionRole + '" id="' + itemId + '-' + globalItemId + '"><a class="aui-list-item-link" role="presentation" /></li>'),
