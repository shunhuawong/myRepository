...
<%@ page import="com.atlassian.jira.user.util.RecoveryMode" %>
...
<page:applyDecorator id="login-form" name="auiform">
    ...
    <ww:if test="@recoveryMode/recoveryModeOn == true">
        <aui:component template="auimessage.jsp" theme="'aui'">
            <aui:param name="'messageType'">warning</aui:param>
            <aui:param name="'messageHtml'">
                <p>
                    <ww:text name="'jira.recoverymode.login.message'">
                        <ww:param name="'value0'"><ww:property value="@recoveryMode/recoveryUsername/orNull"/></ww:param>
                        <ww:param name="'value1'"><a target="_blank" href="<ww:help-url key="recovery-mode"/>"></ww:param>
    ...
    <aui:component template="auimessage.jsp" theme="'aui'">
        ...
        <ww:if test="@loggedInUser != null">
            <p>
                <ww:text name="'login.required.loggedin.permissionviolation'">
