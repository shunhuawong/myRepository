AJS.test.require(["jira.webresources:manageshared"], function(){
    ...
    var href1 = "/jira/secure/ConfigurePortalPages!default.jspa?view=favourites";
    var href2 = "/jira/secure/ConfigurePortalPages!default.jspa?view=my";

    var utilModuleName = "jira/tabs/tab-manager/util";
    var markup = '<ul class="vertical tabs">'
            + '<li class="active first-tab"><a href="' + href1 + '">Favourites</a></li>'
            + '<li class="second-tab"><a href="' + href2 + '">My filters</a></li>'
            + '</ul>';
    ...
    module("TabManager", {
        ...
        prepareTabManagerUtilStub: function(){
