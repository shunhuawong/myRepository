AJS.test.require(["jira.webresources:jqlautocomplete"], function() {
    ...
    var MyParser = require("jira/jql/jql-parser");

    function _testParse(query, expectedResult) {
        test("test query: " + query, function() {
            // parser
            var parser = MyParser(ALL_RESERVED_WORDS);
    ...
    // constants
    var PARSE_FAIL = "PARSE_FAIL";
    var SUCCESS = "SUCCESS";
    var ILLEGAL_CHARS_STRING = "{}*/%+$#@?;";
    var SOME_RESERVED_WORDS = ["abort", "access", "add", "after", "alias", "all", "alter", "and", "any", "as", "asc"];
    var ALL_RESERVED_WORDS = ["greater", "for", "privileges", "float", "validate", "distinct", "of", "break", "defaults", "byte"
