define('jira/project/permissions/addpermissionview', [
    'backbone',
    'jquery',
    'underscore',
    "jira/project/permissions/addgrantcollectionview"
], function (Backbone,
             $,
             _,
             AddGrantCollectionView) {
    "use strict";
    ...
    return Backbone.View.extend({
        ...
        open: function() {
            this.addDialog.show();
            this.addDialog.on("hide", _.bind(this.close, this));
            this.render();
        },
         ...
         */
        _removeInfoInlineDialogs: function() {
        ...
        _handleSubmitState: function () {
            ...
            if (this.permissionTargetSelect.val() && selectedPermissionType != null && selectedPermissionType.isValid() && this.grantsView.isSelectedVisible()) {
        ...
        _handlePermissionTargetSelect: function () {
            this._handleSubmitState();
        },

        _handleSecurityTypeSelected: function () {
            this._handleSubmitState();
        },

        _toggleShowMore: function (model, showMore) {
            if (showMore) {
                this.showMoreBtn.text(AJS.I18n.getText('admin.permission.project.security.types.less'));
                this.$(".secondary").show();
            }
            else {
                this.showMoreBtn.text(AJS.I18n.getText('admin.permission.project.security.types.more'));
                this.$(".secondary").hide();
            }
        ...
        _handleSecurityTypeToggleClick: function (e) {
            e.preventDefault();
        ...
        _renderSecurityTypeList: function () {
        ...
        _renderPermissionTargetSelect: function () {
        ...
        _handleSubmitDisabled: function(model, disabled) {
