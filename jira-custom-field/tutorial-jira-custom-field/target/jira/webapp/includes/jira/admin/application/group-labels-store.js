define("jira/admin/application/group-labels-store", [
    "jquery",
    "underscore"
], function (
    $,
    ...
    var GroupLabelsStore = {
        ...
        syncLabels: function (groupName, roleName, callback) {
            var listener = {
                groupName: groupName,
                roleName: roleName,
                callback: callback
        ...
        doRequest: _.debounce(function () {
            this.lastRequest = $.get(contextPath + "/rest/internal/2/applicationrole/groups")
                .then(this.triggerListeners.bind(this));
        }, 50),

        triggerListeners: function(result) {
        ...
        triggerListener: function (listener, result) {
